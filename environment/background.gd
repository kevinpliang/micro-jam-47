...
@export var tile_size: int = 200  # Larger tiles for better performance
@export var render_distance: int = 15  # Fewer tiles

var player: Node2D
var tiles: Dictionary = {}  # Track spawned tiles
var last_center_tile: Vector2i = Vector2i(999999, 999999)  # Track last update position
var grass_colors = [
	Color(0.5, 0.7, 0.3),  # Dark green
	Color(0.6, 0.8, 0.4),  # Medium green
	Color(0.7, 0.9, 0.5),  # Light green
]
